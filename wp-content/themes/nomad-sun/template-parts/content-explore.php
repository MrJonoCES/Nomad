<div class="container center ph4-l mb5 mb6-l">
        ...
        <div class="flex-ns flex-wrap justify-between">
            ...
            <?php
            // organise our options into a data object, basically a set of options, getting 3 posts and putting them in a random order
            $args = array(
            'posts_per_page' => 3,
            'orderby' => 'rand',
                // here we make sure to exclude the current post we’re looking at
                'post__not_in' => array($post->ID)
            );

            // a variable with our query and options
            $query = new WP_Query( $args );
            // do a loop with our new query code, by looking for posts, and looping over them with 'while' 
